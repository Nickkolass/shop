...
<section class="content">
  <div class="container-fluid">
    <form action="{{ route('product.createProperties_product') }}" method="post" enctype="multipart/form-data">
      @csrf
          ...
          <div class="row" style="margin:5px">
            ...
            <div class="col" style="padding: 5px;">
              ...
              <select name="category_id" id="category_id" class="categories" style="width: 100%;" required> 
                ...
                <option value="{{ $category_id }}" @selected(old('category_id')==$category_id)>{{ $category_title_rus }}</option>
                @endforeach
              </select>
            </div>
            <div class="w-100"></div>
            ...
            <div class="col" style="padding: 5px;">
              ...
              <select name="tags[]" class="tags" multiple="multiple" style="width: 100%;" required>
                ...
                <option value="{{ $tag_id }}" @selected(in_array($tag_id, old('tags') ?? []))>{{ $tag_title }}</option>
                @endforeach
              </select>
            </div>
            <div class="w-100"></div>
