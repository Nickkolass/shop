...
<section class="content">
  <div class="container-fluid">
    <form action="{{ route('productType.update_productType', $productType->id) }}" method="post" enctype="multipart/form-data">
      @csrf
      @method('patch')
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover text-nowrap">
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <select name="optionValues[]" class="tags" style="width:200px">
                      ...
                      <option value="{{ $value_id }}" @selected($productType->optionValues->contains($value_id))>{{ $value }}</option>
                      @endforeach
                    </select>
                    @endforeach
                  </td>
                ...
                <tr>
                  <td>Цена</td>
                  <td><input type="number" name="price" class="form-control" value="{{ $productType->price }}"></td>
                </tr>
                <tr>
                  <td>Остаток</td>
                  <td><input type="number" name="count" class="form-control" value="{{ $productType->count }}"></td>
                </tr>
                <tr>
                  <td>Опубликовать</td>
                  <td><input style="width:50px;"type="checkbox" name="is_published" value='1' class="form-control" @checked($productType->is_published)></td>
                </tr>
                <tr>
                  <td>Заставка</td>
                  <td>
                          ...
                          <div class="control-group" id="exampleInputFile">
                            <div class="controls">
                              <div class="entry input-group upload-input-group">
                                ...
                                <img src="{{ asset('/storage/'.$productType->preview_image) }}" width='70' height='70' class="img img-responsive">
                              </div>
                            </div>
                          </div>
                        </div>
