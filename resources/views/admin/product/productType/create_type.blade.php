...
<section class="content">
  <div class="container-fluid">
    <form action="{{ route('productType.store_productType', $product->id) }}" method="post" enctype="multipart/form-data">
      @csrf
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover text-nowrap">
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <select name="optionValues[]" class="tags" style="width:200px">
                      ...
                      <option value="{{ $id }}" @selected(in_array($id, old('optionValues') ?? [] ))>{{ $title }}</option>
                      @endforeach
                    </select>
                    @endforeach
                  </td>
                ...
                <tr>
                  <td>Цена</td>
                  <td><input type="number" name="price" class="form-control" value="{{ old('price') }}"></td>
                </tr>
                <tr>
                  <td>Остаток</td>
                  <td><input type="number" name="count" class="form-control" value="{{ old('count') }}"></td>
                </tr>
                <tr>
                  <td>Опубликовать</td>
                  <td><input style="width:50px;"type="checkbox" name="is_published" value='1' class="form-control" @checked(old('is_published'))></td>
                </tr>
                <tr>
                  <td>Заставка</td>
                  <td>
