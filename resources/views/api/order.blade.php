...
<div class="container-md">
    <div class="row justify-content-md-center">
        <div class="col-3">
            <form action="{{ route('api.ordering_api') }}" method="post" style="text-align: center">
                @csrf
                <div class="card-body table-responsive">
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                <td>Способ оплаты {{$data['total_price'] }} руб.</td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="cd-filter-block">
                                    ...
                                    <div class="cd-filter-block">
                                        <ul class="cd-filter-content cd-filters list">
                                            <li>
                                                ...
                                                <label class="radio-label" for="radio">Согласен с условиями правил пользования <br> торговой площадкой и правилами возврата</label>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
                ...
                <input type="number" name="total_price" value= "{{ $data['total_price'] }}" hidden>
                @if (auth()->check())
                <input type="submit" class="btn btn-primary btn-lg" style="height: 50px; width: 200px" value="Перейти к оплате">
                @else
                <a type="submit" class="btn btn-primary btn-lg" style="height: 50px; width: 200px" href="{{ route('login') }}">Для оформления заказа <br> зарегистрируйтесь</a>
                @endif
            </form>
        </div>
    </div>
