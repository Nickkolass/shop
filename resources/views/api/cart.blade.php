...
<main class="cd-main-content">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr style="text-align: center">
                    ...
                    <td style="vertical-align: middle"><a href="{{ route('api.product', [$productType['category'], $productType['id']]) }}">
    ...
    <div style="text-align: center">
        ...
        <a type="submit" class="btn btn-primary btn-lg" style="height: 50px; width: 200px" href="{{ session()->has('user_role') ? route('api.orders.create', ['totalPrice' => $totalPrice]) : route('login') }}">
