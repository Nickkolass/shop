...
<main class="cd-main-content">
  <div>
    <ul class="nav justify-content-center">
      <li class="nav-item">
        <br><a class="nav-link" href="{{ route('api.products_api', [$data['category']['title'], 'page' => str_contains($_SERVER['HTTP_REFERER'], 'page=') ? str_replace('http://127.0.0.1:8876/products/chokolate?page=', '', $_SERVER['HTTP_REFERER']) : 1]) }}">Назад</a>
      </li>
    </ul>
  </div>
          ...
          <div class="product-item" style="text-align: center">
            ...
            <div class="qty mt-5">
              <form action="{{ route('api.addToCart_api') }}" method="post">
                ...
                <input type="submit" class="btn btn-primary btn-lg btn-block" style="height: 40px" value="{{$data['product']['count']!==0 ? 'В корзину' : 'Нет в наличии'}}" {{$data['product']['count']==0 ? 'disabled' : ''}}>
              </form>
            </div>
            ...
            <div style="text-align: center">
              ...
              <ul class="nav nav-pills">
                ...
                @else
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('api.product_api', [$data['category']['title'], $prod['id']]) }}">
