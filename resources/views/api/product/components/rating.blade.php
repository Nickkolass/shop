    ...
    <div class="row" style="padding:10px">
        ...
        <div class="col-sm">
            <form action="{{ route('api.liked.toggle', $productType['id']) }}" method="post">
                ...
                <button type="submit" class="border-0 bg-transparent"
                    ...
                    <i class="fa fa-heart{{isset($data['liked_ids'][$productType['id']]) || !empty($productType['likeable']) ? '': '-o'}}"
        ...
        <div class="col-sm">
            <li style="list-style-type: none;"><a href="#comments"
                                                  style="{{isset($productType['product']['description']) ?: 'pointer-events:none; color:black'}}">
