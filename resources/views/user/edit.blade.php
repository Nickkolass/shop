                ...
                <form action="{{ route('users.update', $user->id) }}" method="post">
                    ...
                    <div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{ $user->age }}" name="age" class="form-control"
                        ...
                        @if($user->isAdmin() || $user->isSaler())
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{ $user->INN }}" name="INN" class="form-control"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{ $user->registredOffice }}" name="registredOffice"
